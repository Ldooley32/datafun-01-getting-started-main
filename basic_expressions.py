...
logger.info(f"Rectangle length = {rectangle_length}, and rectangle_width = {rectangle_width}, rectangle_area = {rectangle_area}" 
)
logger.info(f"Retangle_perimeter = {rectangle_length * 2 + rectangle_width * 2}")          
